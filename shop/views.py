...
def product_detail(request,id,slug):
    ...
    r=Recommender()
    recommender_products=r.suggest_products_for([product],max_results=4)
    return render(request,'shop/product/detail.html',{'product':product,'cart_product_form':cart_product_form,'recommender_products':recommender_products})
